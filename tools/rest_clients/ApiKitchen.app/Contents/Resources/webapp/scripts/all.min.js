...
(function(b){var a={};b.publish=function(d,c){console.log("Publish request for topic "+d);a[d]&&b.each(a[d],function(){this.apply(b,c||[])})};b.subscribe=function(c,d){console.log("Subscribe request for topic "+c);if(!a[c]){a[c]=[]}a[c].push(d);return[c,d]};b.unsubscribe=function(d){console.log("Unsubscribe request for topic "+topic);var c=d[0];a[c]&&b.each(a[c],function(e){if(this==d[1]){a[c].splice(e,1)}})}})(jQuery);
...
(function(){window.form2object=function(k,g,d){if(typeof d=="undefined"||d==null){d=true}if(typeof g=="undefined"||g==null){g="."}k=typeof k=="string"?document.getElementById(k):k;var o=b(k);var t={};var h={};for(var n=0;n<o.length;n++){var p=o[n].value;if(d&&p===""){continue}var f=o[n].name;var m=f.split(g);var q=t;for(var l=0;l<m.length;l++){var r=m[l];var e;if(r.indexOf("[]")>-1&&l==m.length-1){e=r.substr(0,r.indexOf("["));if(!q[e]){q[e]=[]}q[e].push(p)}else{if(r.indexOf("[")>-1){e=r.substr(0,r.indexOf("["));var s=r.replace(/^[a-z]+\[|\]$/gi,"");if(!h[e]){h[e]={}}if(!q[e]){q[e]=[]}if(l==m.length-1){q[e].push(p)}else{if(!h[e][s]){q[e].push({});h[e][s]=q[e][q[e].length-1]}}q=h[e][s]}else{if(l<m.length-1){if(!q[r]){q[r]={}}q=q[r]}else{q[r]=p}}}}}return t};function b(f){var d=[];var g=f.firstChild;while(g){if(g.nodeName.match(/INPUT|SELECT|TEXTAREA/i)){var h=a(g);if(h!==null){d.push({name:g.name,value:h})}}else{var e=b(g);d=d.concat(e)}g=g.nextSibling}return d}function a(d){switch(d.nodeName){case"INPUT":case"TEXTAREA":switch(d.type.toLowerCase()){case"radio":case"checkbox":if(d.checked){return d.value}break;case"button":case"reset":case"submit":case"image":return"";break;default:return d.value;break}break;case"SELECT":return c(d);break;default:break}return null}function c(h){var e=h.multiple;if(!e){return h.value}var d=[];for(var g=h.getElementsByTagName("option"),j=0,f=g.length;j<f;j++){if(g[j].selected){d.push(g[j].value)}}return d}window.form2json=window.form2object})();
$(document).ready(function(){$.kitchen=$.kitchen||{};$.kitchen.Helper=function(){function a(e){$("input.request-header-names",e).autocomplete({source:["Accept","Accept-Charset","Accept-Encoding","Accept-Language","Authorization","Cache-Control","Connection","Cookie","Content-Length","Content-MD5","Content-Type","Date","Expect","From","Host","If-Match","If-Modified-Since","If-None-Match","If-Range","If-Unmodified-Since","Max-Forwards","Pragma","Proxy-Authorization","Range","Referer","TE","Upgrade","User-Agent","Via","Warning"]})}function b(f,e){$('#tabs a[href="'+f+'"]').children(":first-child").removeClass().addClass(e)}function d(e,f){$('#tabs a[href="'+e+'"]').children(":first-child").html(f)}function c(){if(window.container){console.debug("Container mode detected. Using CurlDrain");return CurlDrain}else{console.debug("Web mode detected. Using Drain");return Drain}}return{registerHeaderNamesAutoComplete:a,setTabTitleClass:b,setTabTitle:d,getDrain:c}}()});
$(document).ready(function(){$.kitchen=$.kitchen||{};$.kitchen.HttpHelper=function(){function a(c){var b={"100":"Continue","101":"Switching Protocols","200":"OK","201":"Created","202":"Accepted","203":"Non-Authoritative Information","204":"No Content","205":"Reset Content","206":"Partial Content","300":"Multiple Choices","301":"Moved Permanently","302":"Found","303":"See Other","304":"Not Modified","305":"Use Proxy","307":"Temporary Redirect","400":"Bad Request","401":"Unauthorized","402":"Payment Required","403":"Forbidden","404":"Not Found","405":"Method Not Allowed","406":"Not Acceptable","407":"Proxy Authentication Required","408":"Request Timeout","409":"Conflict","410":"Gone","411":"Length Required","412":"Precondition Failed","413":"Request Entity Too Large","414":"Request-URI Too Long","415":"Unsupported Media Type","416":"Requested Range Not Satisfiable","417":"Expectation Failed","500":"Internal Server Error","501":"Not Implemented","502":"Bad Gateway","503":"Service Unavailable","504":"Gateway Timeout","505":"HTTP Version Not Supported"};return c+" "+(c in b?b[c]:"")}return{techStatusCode:a}}()});
var Cabinet=function(){this.lastSink=null;var a=$.kitchen.tabHolder.tabs("option","nextId");var b="#tabs-"+a;console.debug("Creating a new with id "+b);$.kitchen.tabHolder.tabs("add",b,"");$.kitchen.cabinets[b]=this;$.kitchen.tabHolder.tabs("option","nextId",a+1);$("#tabTmpl").tmpl([{tabId:b,formId:"tabs-"+a+"-form"}]).appendTo(b);this.cabinetId=b;$.kitchen.Helper.setTabTitle(this.cabinetId,"New Tab");this.registerCabinetHandlers();$.subscribe("/cabinets/state/loading/"+this.cabinetId,$.proxy(this.loading,this));$.subscribe("/cabinets/state/success/"+this.cabinetId,$.proxy(this.loaded,this));$.subscribe("/cabinets/state/failed/"+this.cabinetId,$.proxy(this.failed,this));$.kitchen.tabHolder.tabs("select",$.kitchen.tabHolder.tabs("length")-1)};Cabinet.open=function(a){$.ajax({url:$.kitchen.Settings.kitchen_url+a,type:"get",dataType:"json",success:function(d,f,e){var g=new Cabinet();var b=new Sink();b.callback(d);g.load(b)},error:function(d,b){console.error("Could not load recipe due to "+d);var e=new Cabinet()}})};Cabinet.prototype.clone=function(){var a=new Cabinet();a.load(this.lastSink)};Cabinet.prototype.load=function(b){var d=$.extend(true,{},b);d.cabinetId=this.cabinetId;$('input[name="url"]',this.cabinetId).val(d.formData.url);for(var a in d.formData.headers){var c=this.addHeaderRow();$("input[tag="+c+"-name]",this.cabinetId).val(d.formData.headers[a].name);$("input[tag="+c+"-value]",this.cabinetId).val(d.formData.headers[a].value)}for(var f in d.formData.params){var e=this.addParamRow();$("input[tag="+e+"-name]",this.cabinetId).val(d.formData.params[f].name);$("input[tag="+e+"-value]",this.cabinetId).val(d.formData.params[f].value)}if(d.formData.body){this.showPostBody();$("textarea[name=body]",this.cabinetId).val(d.formData.body)}this.loaded(d)};Cabinet.prototype.loading=function(){console.debug("Changing state to loading for "+this.cabinetId);$.kitchen.Helper.setTabTitleClass(this.cabinetId,"working-icon");$.kitchen.Helper.setTabTitle(this.cabinetId,"Loading...");this.activateExecuteButton(false,"Loading...")};Cabinet.prototype.activateExecuteButton=function(c,b){var a=$(".execute",this.cabinetId);if(c){a.removeClass("disabled")}else{a.addClass("disabled")}a.html(b)};Cabinet.prototype.loaded=function(b){console.debug("Changing state to loaded for "+this.cabinetId);this.activateExecuteButton(true,"Execute");var a=$(this.cabinetId);$(".request-section",a).hide();$(".response-section",a).html("");var c={tabId:this.cabinetId,sink:b};$("#responseSectionTmpl").tmpl([c]).appendTo($(".response-section",a));this.registerResponseHandlers();if(parseInt(b.responseHeaders.status)>399){$.kitchen.Helper.setTabTitleClass(this.cabinetId,"server-error-icon")}else{$.kitchen.Helper.setTabTitleClass(this.cabinetId,"ready-icon")}$.kitchen.Helper.setTabTitle(this.cabinetId,b.finalUrl.split(/\/+/g)[1]);console.debug("Highlighting response");$("pre.response-content code",a).each(function(d,f){hljs.highlightBlock(f,"    ")});$(".response-section",a).show();this.lastSink=b};Cabinet.prototype.failed=function(a){console.debug("Changing state to failed for "+this.cabinetId);$.kitchen.Helper.setTabTitleClass(this.cabinetId,"failed-icon");$.kitchen.Helper.setTabTitle(this.cabinetId,"Failed");this.activateExecuteButton(true,"Execute")};Cabinet.prototype.execute=function(b){if(b!=null){console.debug("Using existing sink...");a=b}else{console.debug("Converting to sink and executing...");var a=new Sink(this.cabinetId)}a.execute()};Cabinet.prototype.executeAgain=function(){if(this.lastSink){this.execute(this.lastSink)}else{alert("An internal error has occurred")}};Cabinet.prototype.registerResponseHandlers=function(){$(".back-to-request",$(this.cabinetId)).click(function(){$(this).parent().parent().toggle();$(this).parent().parent().prev().toggle()});$(".execute-again",$(this.cabinetId)).click(function(){var a=$(this).attr("tabId");console.debug("Executing tab with id "+a+" again");var b=$.kitchen.cabinets[a];b.executeAgain()});$(".clone",$(this.cabinetId)).click(function(){var a=$(this).attr("tabId");var b=$.kitchen.cabinets[a];b.clone()});$(".hide-section",$(this.cabinetId)).unbind("click");$(".hide-section",$(this.cabinetId)).click(function(){console.debug("Toggling section. Waiting for animation to complete...");var a=$(this).parent().next().next();a.slideToggle($.proxy(function(){console.debug("Animation complete. Switching button state");var b=$(this).parent().next().next();$(this).removeClass("on off");$(this).addClass(b.is(":visible")?"on":"off")},this));return false});$(".permalink",$(this.cabinetId)).click(function(){console.debug("Popping up permalink window");var a=$(this).attr("tabId");$(".permalink-container",a).toggle("fast");return false})};Cabinet.prototype.registerCabinetHandlers=function(){$(".add-header",a).click($.proxy(this.addHeaderRow,this));$(".post-body",a).click($.proxy(this.showPostBody,this));$(".add-param",a).click($.proxy(this.addParamRow,this));$(".toggle-auth",a).click($.proxy(this.toggleAuth,this));var a=$(this.cabinetId);var b=$(".execute",a);$(".url",a).keyup(function(c){if(c.keyCode==13){b.click()}});$(".execute",a).click(function(){var c=$(this).attr("tabId");var d=$.kitchen.cabinets[c];d.execute()});$(this.cabinetId+"-form").submit(function(){return false});$("a#inline",a).fancybox({hideOnContentClick:true});$("input[name=url]",a).watermark("Type the url and press enter")};Cabinet.prototype.addHeaderRow=function(){var b=$(this.cabinetId);var c=$(".add-header",b).parent().prev();var a=Math.floor(Math.random()*10000);$("#addHeaderTmpl").tmpl([{name:"header",index:a}]).appendTo(c);$.kitchen.Helper.registerHeaderNamesAutoComplete(c);$(".delete-row",b).unbind("click");$(".delete-row",b).click(function(){$(this).parent().remove();return false});return"headers-"+a};Cabinet.prototype.showPostBody=function(){var a=$(this.cabinetId);var b=$(".post-body",a).parent().prev();$("select[name=method]",a).val("post");b.children().hide();$(".request-post-body",b).show();return false};Cabinet.prototype.addParamRow=function(){var b=$(this.cabinetId);$("select[name=method]",b).val("post");var c=$(".add-param",b).parent().prev();if(!$(".request-params",c).is(":visible")){c.children().hide();$(".request-params",c).show();if(jQuery.trim($(".request-params",c).html()).length>0){return}}var a=Math.floor(Math.random()*10000);$("#addHeaderTmpl").tmpl(([{name:"param",index:a}])).appendTo($(".request-params",c));$(".delete-row",b).unbind("click");$(".delete-row",b).click(function(){$(this).parent().remove();return false});return"params-"+a};Cabinet.prototype.toggleAuth=function(){var a=$(this.cabinetId);var b=$(".toggle-auth",a).parent().prev();b.toggle();$(".toggle-auth",a).html(b.is(":visible")?"- Disable HTTP Basic Auth":"+ Enable HTTP Basic Auth");return false};
Drain=function(){function a(b){$.ajax({url:"/cook",type:"post",dataType:"json",data:{sink:b.data},success:function(c,e,d){b.callback(c,e,d)},error:function(d,c){b.errback(d,c)}})}return{execute:a}}();
window.wso_callback=function(a){alert("Callback");console.debug("Got data from container: "+a);parsedJson=$.parseJSON(a);CurlDrain.callback(parsedJson)};window.wso_errback=function(){alert("Err back")};CurlDrain=function(){var b={};function a(d){b[d.cabinetId]=d;window.container.execute_(d.data)}function c(d){console.debug("Sink with id:"+d.id);sink=b[d.id];d.recipe_url="Coming soon!";sink.callback(d)}return{execute:a,callback:c}}();
var Sink=function(a){this.formData={};this.data=[];this.responseHeaders="";this.requestHeaders="";this.response="";this.cabinetId=a};Sink.prototype.execute=function(){$.publish("/cabinets/state/loading/"+this.cabinetId,null);var a=$(".request-section",this.cabinetId).is(":visible");if(a||this.formData==null||this.data==null){this.formData=form2object((this.cabinetId+"-form").substring(1));var b=$(".request-params",this.cabinetId).is(":visible");delete this.formData[b?"body":"params"];this.formData.id=this.cabinetId;if(this.formData.url.indexOf("http")!==0){this.formData.url="http://"+this.formData.url}this.data=JSON.stringify(this.formData,null,"")}$.kitchen.Helper.getDrain().execute(this)};Sink.prototype.callback=function(a){console.debug("Execute completed successfully: "+this.cabinetId);this.responseHeaders=a.headers;this.response=a.content;this.requestHeaders=a.request_headers;this.method=a.method;this.finalUrl=a.final_url;this.totalRequestTime=a.total_request_time;this.status_code=a.status_code;this.status_code_tech=a.status_code_tech||$.kitchen.HttpHelper.techStatusCode(a.status_code);this.status_code_human=a.status_code_human||$.kitchen.HttpHelper.techStatusCode(a.status_code_human);this.content_lang=a.content_lang;this.recipe_id=a.recipe_id;this.recipe_url=a.recipe_url;if(a.formData){this.formData=a.formData}$.publish("/cabinets/state/success/"+this.cabinetId,[this])};Sink.prototype.errback=function(a){console.debug("Execute completed with error: "+this.cabinetId+"::"+a.status);$.publish("/cabinets/state/failed/"+this.cabinetId,[this])};
$(document).ready(function(){$.kitchen=$.kitchen||{};$.kitchen.Settings={};$.kitchen.Settings.kitchen_url="http://apikitchen.com/serve/"});
Function.prototype.partial=function(){var b=this,a=Array.prototype.slice.call(arguments);return function(){var c=0;for(var d=0;d<a.length&&c<arguments.length;d++){if(a[d]===undefined){a[d]=arguments[c++]}}return b.apply(this,a)}};function addCabinet(){var a=new Cabinet()}function closeActiveCabinet(){var a=$.kitchen.tabHolder.tabs("option","selected");$.kitchen.tabHolder.tabs("remove",a)}function shiftToTab(b){if($.kitchen.tabHolder){var a=$.kitchen.tabHolder.tabs("option","selected");$.kitchen.tabHolder.tabs("select",(a+b))}}function loadTemplates(){$.get("templates/_all.tmpl.htm",{},function(a){$("body").append($(a));registerGlobalHandlers();loadInitialCabinet()},"text")}function loadInitialCabinet(){if(window.location.hash){console.debug("Found hash "+window.location.hash);Cabinet.open(window.location.hash.substr(1))}else{console.debug("No hash found. Loading default empty cabinet");addCabinet()}}function registerGlobalHandlers(){$("#add-tab-button").click(addCabinet);$("#tabs span.ui-icon-close").live("click",function(){var a=$("li",$.kitchen.tabHolder).index($(this).parent());$.kitchen.tabHolder.tabs("remove",a)})}function registerKeyboardMap(){$(document).bind("keydown","ctrl+n",addCabinet);$(document).bind("keydown","ctrl+w",closeActiveCabinet);$(document).bind("keydown","ctrl+o",function(){shiftToTab(-1)});$(document).bind("keydown","ctrl+p",function(){shiftToTab(1)})}function initCabinets(){$.kitchen.tabHolder=$("#tabs").tabs({tabTemplate:"<li><a href='#{href}' class='tab-title'><span class='new-icon'></span>#{label}</a><span class='ui-icon ui-icon-close'>Remove Tab</span></li>",remove:function(a,b){console.debug("Deleting cabinet with id "+b.tab.hash);delete $.kitchen.cabinets[b.tab.hash]}});$.kitchen.tabHolder.tabs("option","nextId",1)}$(document).ready(function(){$.kitchen=$.kitchen||{};$.kitchen.cabinets={};registerKeyboardMap();initCabinets();loadTemplates()});
